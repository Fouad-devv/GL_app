    ...
    <#elseif section = "form">
        <style>
            ...
            *, *::before, *::after { box-sizing: border-box; }
            ...
            .g-card  { width:100%;max-width:440px; }
            ...
            .g-ctitle { font-size:clamp(22px,2.4vw,28px);font-weight:800;letter-spacing:-.03em;margin-bottom:7px;color:#e2e8f0; }
            ...
            .g-alert.info    { background:rgba(249,115,22,.08);  border:1px solid rgba(249,115,22,.3);color:#93c5fd; }
            ...
            .g-req   { color:#f87171;margin-left:3px; }
            ...
            .g-inp.error { border-color:rgba(248,113,113,.5); }
            ...
            .g-note { display:flex;align-items:center;gap:8px;padding:11px 14px;background:rgba(249,115,22,.06);border:1px solid rgba(249,115,22,.15);border-radius:9px;font-size:12.5px;color:#94a3b8;margin-top:2px; }
            ...
            .g-chips { display:flex;justify-content:center;gap:8px;margin-top:22px;flex-wrap:wrap; }
        ...
        <div class="g-page">
            ...
            <div class="g-left">
                ...
                <div class="g-lcont">
                    <div class="g-eyebrow"><div class="g-edot"></div>Configuration du profil</div>
                    <h2 class="g-ltitle">Finalisez votre<br/>accès à la<br/><span>plateforme</span></h2>
                    <p class="g-ldesc">Renseignez vos informations pour personnaliser votre expérience et permettre à votre équipe de vous identifier.</p>
                    <div class="g-feats">
                        <div class="g-feat"><span class="g-fi">👤</span><span class="g-ft">Identité visible par votre équipe</span></div>
                        <div class="g-feat"><span class="g-fi">🔔</span><span class="g-ft">Notifications et affectations d'interventions</span></div>
                        <div class="g-feat"><span class="g-fi">🔒</span><span class="g-ft">Données protégées — stockage sécurisé</span></div>
                    </div>
                    <div class="g-svg">
                        <svg viewBox="0 0 320 110" fill="none" style="width:100%;max-width:320px;">
                            ...
                            <rect x="97"  y="68" width="7"   height="12" rx="1" fill="rgba(249,115,22,.7)"/>
                            <rect x="107" y="62" width="7"   height="18" rx="1" fill="rgba(251,146,60,.7)"/>
                            <rect x="117" y="55" width="7"   height="25" rx="1" fill="rgba(245,158,11,.7)"/>
                            <rect x="127" y="64" width="7"   height="16" rx="1" fill="rgba(249,115,22,.7)"/>
                            <rect x="137" y="52" width="7"   height="28" rx="1" fill="rgba(251,146,60,.7)"/>
                            <rect x="147" y="59" width="7"   height="21" rx="1" fill="rgba(245,158,11,.7)"/>
                            ...
                            <circle cx="225" cy="37" r="4" fill="#f97316" opacity=".9"/>
            ...
            <div class="g-right">
                <div class="g-card">
                    <div class="g-chdr">
                        <div class="g-ctag"><div class="g-ctdot"></div>Première connexion</div>
                        <h1 class="g-ctitle">Complétez votre profil</h1>
                        <p class="g-csub">Ces informations permettront à votre responsable de vous identifier dans le système.</p>
                    </div>
                    ...
                    <form class="g-form" action="${url.loginAction}" method="post">

                        <#if user.editUsernameAllowed??>
                        <div class="g-group">
                            <label class="g-lbl" for="username">Nom d'utilisateur<span class="g-req">*</span></label>
                            <div class="g-wrap">
                                <span class="g-icon">
                                ...
                                <input class="g-inp <#if messagesPerField.existsError('username')>error</#if>" type="text" id="username" name="username" value="${(user.username!'')}" autofocus autocomplete="username" placeholder="Nom d'utilisateur" />
                            </div>
                            <#if messagesPerField.existsError('username')>
                            <span class="g-ierr">${kcSanitize(messagesPerField.getFirstError('username'))?no_esc}</span>
                            </#if>
                        </div>
                        </#if>
                        ...
                        <div class="g-row">
                            <div class="g-group">
                                <label class="g-lbl" for="firstName">Prénom<span class="g-req">*</span></label>
                                <div class="g-wrap">
                                    <span class="g-icon">
                                        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                    </span>
                                    <input class="g-inp <#if messagesPerField.existsError('firstName')>error</#if>" type="text" id="firstName" name="firstName" value="${(user.firstName!'')}" placeholder="Prénom" />
                                </div>
                                <#if messagesPerField.existsError('firstName')>
                                <span class="g-ierr">${kcSanitize(messagesPerField.getFirstError('firstName'))?no_esc}</span>
                                </#if>
                            </div>

                            <div class="g-group">
                                <label class="g-lbl" for="lastName">Nom<span class="g-req">*</span></label>
                                <div class="g-wrap">
                                    <span class="g-icon">
                                        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                    </span>
                                    <input class="g-inp <#if messagesPerField.existsError('lastName')>error</#if>" type="text" id="lastName" name="lastName" value="${(user.lastName!'')}" placeholder="Nom de famille" />
                                </div>
                                <#if messagesPerField.existsError('lastName')>
                                <span class="g-ierr">${kcSanitize(messagesPerField.getFirstError('lastName'))?no_esc}</span>
                                </#if>
                            </div>
                        </div>

                        <div class="g-group">
                            <label class="g-lbl" for="email">Adresse e-mail<span class="g-req">*</span></label>
                            <div class="g-wrap">
                                <span class="g-icon">
                                ...
                                <input class="g-inp <#if messagesPerField.existsError('email')>error</#if>" type="email" id="email" name="email" value="${(user.email!'')}" autocomplete="email" placeholder="adresse@example.com" />
                            </div>
                            <#if messagesPerField.existsError('email')>
                            <span class="g-ierr">${kcSanitize(messagesPerField.getFirstError('email'))?no_esc}</span>
                            </#if>
                        </div>

                        <div class="g-note">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fb923c" stroke-width="2" style="flex-shrink:0"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                            Ces informations seront visibles par les administrateurs et votre responsable de maintenance.
                        </div>

                        <button class="g-btn" type="submit" id="kc-submit">
                            <span class="g-binn">
                                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/></svg>
                    ...
                    <div class="g-sec">
                        ...
                        Données chiffrées · Keycloak SSO · OAuth 2.0 / JWT
                    </div>

                    <div class="g-chips">
                        <div class="g-chip"><div class="g-cdot gg"></div>Système actif</div>
                        <div class="g-chip"><div class="g-cdot gb"></div>Profil sécurisé</div>
                        <div class="g-chip"><div class="g-cdot gp"></div>Chiffrement JWT</div>
                    </div>
                </div>
            </div>
        ...
        <script>
        (function(){
            var f=document.querySelector('form'),b=document.getElementById('kc-submit');
            if(f&&b){f.addEventListener('submit',function(){b.disabled=true;var i=b.querySelector('.g-binn');if(i)i.innerHTML='<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="animation:spin .8s linear infinite"><circle cx="12" cy="12" r="10" stroke-opacity=".25"/><path d="M22 12a10 10 0 0 0-10-10" stroke-linecap="round"/></svg> Enregistrement…';});}
        })();
        </script>
