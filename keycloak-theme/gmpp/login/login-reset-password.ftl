...
<@layout.registrationLayout displayInfo=true displayMessage=!messagesPerField.existsError('username'); section>
    ...
    <#elseif section = "form">
        <style>
            ...
            *, *::before, *::after { box-sizing: border-box; }
            ...
            .g-ctag { display:inline-flex;align-items:center;gap:7px;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#06b6d4;background:rgba(6,182,212,.08);border:1px solid rgba(6,182,212,.2);padding:5px 12px;border-radius:100px;margin-bottom:16px; }
            .g-ctdot { width:5px;height:5px;border-radius:50%;background:#06b6d4;box-shadow:0 0 6px #06b6d4;animation:pulse 2s ease-in-out infinite; }
            ...
            /* Info box (check-your-email state) */
            .g-info { display:flex;align-items:flex-start;gap:12px;padding:16px;border-radius:12px;background:rgba(6,182,212,.06);border:1px solid rgba(6,182,212,.2);margin-top:20px; }
            .g-info-icon { width:36px;height:36px;border-radius:9px;background:rgba(6,182,212,.12);display:flex;align-items:center;justify-content:center;flex-shrink:0; }
            .g-info-text { font-size:13px;color:#94a3b8;line-height:1.6; }
            .g-info-text strong { color:#67e8f9;display:block;margin-bottom:3px;font-size:14px; }
            ...
            .g-inp:focus { border-color:rgba(6,182,212,.5);background:rgba(13,18,37,.98);box-shadow:0 0 0 3px rgba(6,182,212,.1); }
            .g-inp:focus ~ .g-icon, .g-wrap:focus-within .g-icon { color:#06b6d4; }
            .g-ierr  { font-size:12px;color:#f87171;margin-top:4px;font-weight:500; }

            /* Submit btn — cyan accent for reset page */
            .g-btn { position:relative;overflow:hidden;width:100%;padding:15px 24px;background:linear-gradient(135deg,#0891b2,#0e7490);border:none;border-radius:10px;cursor:pointer;font-family:'Outfit',sans-serif;font-size:16px;font-weight:700;color:#fff;display:flex;align-items:center;justify-content:center;gap:10px;transition:transform .2s,box-shadow .2s;margin-top:4px; }
            .g-btn::before { content:'';position:absolute;inset:0;background:linear-gradient(135deg,#06b6d4,#0891b2);opacity:0;transition:opacity .25s; }
            ...
            .g-btn:hover   { transform:translateY(-2px);box-shadow:0 14px 40px rgba(6,182,212,.4); }
            ...
            /* Back to login link */
            .g-back { display:flex;align-items:center;justify-content:center;gap:7px;margin-top:22px;font-family:'JetBrains Mono',monospace;font-size:11px;color:#4b5563;text-decoration:none;letter-spacing:.05em;transition:color .2s; }
            .g-back:hover { color:#fb923c; }
            .g-back svg { transition:transform .2s; }
            .g-back:hover svg { transform:translateX(-3px); }
            ...
            .g-cdot.gb { background:#06b6d4;box-shadow:0 0 6px #06b6d4;animation-delay:.5s; }
        ...
        <div class="g-page">
            ...
            <div class="g-left">
                ...
                <div class="g-lcont">
                    <div class="g-eyebrow"><div class="g-edot"></div>Récupération de compte</div>
                    <h2 class="g-ltitle">Réinitialisez<br/>votre<br/><span>mot de passe</span></h2>
                    <p class="g-ldesc">Recevez un lien sécurisé par e-mail pour réinitialiser votre accès à la plateforme.</p>
                    <div class="g-feats">
                        <div class="g-feat"><span class="g-fi">📧</span><span class="g-ft">Lien de réinitialisation sécurisé</span></div>
                        <div class="g-feat"><span class="g-fi">⏱️</span><span class="g-ft">Lien valide pendant 5 minutes</span></div>
                        <div class="g-feat"><span class="g-fi">🔒</span><span class="g-ft">Processus chiffré de bout en bout</span></div>
                        <div class="g-feat"><span class="g-fi">✅</span><span class="g-ft">Accès rétabli immédiatement</span></div>
                    </div>
                    <div class="g-svg">
                        <svg viewBox="0 0 320 110" fill="none" style="width:100%;max-width:320px;">
                            ...
                            <rect x="76"  y="22" width="168" height="76" rx="6" fill="rgba(13,18,37,.9)" stroke="rgba(6,182,212,.3)" stroke-width="1.2"/>
                            <rect x="90"  y="32" width="104" height="52" rx="3" fill="rgba(3,7,18,.9)"   stroke="rgba(6,182,212,.25)" stroke-width="1"/>
                            <!-- envelope icon -->
                            <rect x="104" y="47" width="72" height="48" rx="4" fill="none" stroke="rgba(6,182,212,.6)" stroke-width="1.5"/>
                            <polyline points="104,47 140,71 176,47" fill="none" stroke="rgba(6,182,212,.6)" stroke-width="1.5"/>
            ...
            <div class="g-right">
                <div class="g-card">
                    <div class="g-chdr">
                        <div class="g-ctag"><div class="g-ctdot"></div>Récupération de compte</div>
                        <h1 class="g-ctitle">Mot de passe oublié ?</h1>
                        <p class="g-csub">Saisissez votre identifiant ou e-mail. Nous vous enverrons un lien pour réinitialiser votre mot de passe.</p>
                    </div>
                    ...
                    <form class="g-form" id="kc-reset-password-form" action="${url.loginAction}" method="post">

                        <div class="g-group">
                            <label class="g-lbl" for="username">
                            ...
                            <div class="g-wrap">
                                ...
                                <input
                                    ...
                                    autocapitalize="off"
                                    spellcheck="false"
                                    placeholder="<#if !realm.loginWithEmailAllowed>Nom d'utilisateur<#elseif !realm.registrationEmailAsUsername>Identifiant ou adresse e-mail<#else>adresse@example.com</#if>"
                        ...
                        <button tabindex="2" class="g-btn" type="submit">
                            <span class="g-binn">
                    ...
                    <a href="${url.loginUrl}" class="g-back">
                    ...
                    <div class="g-sec">
                        ...
                        Lien sécurisé · Expire après utilisation
                    </div>

                    <div class="g-chips">
                        <div class="g-chip"><div class="g-cdot gg"></div>Système actif</div>
                        <div class="g-chip"><div class="g-cdot gb"></div>Lien chiffré</div>
    ...
    <#elseif section = "info">
        <div class="g-info" style="position:fixed;bottom:24px;right:24px;width:320px;z-index:100;animation:slideUp .5s ease both;">
            <div class="g-info-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#67e8f9" stroke-width="2">
                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                    <polyline points="22,6 12,13 2,6"/>
                </svg>
            </div>
            <div class="g-info-text">
                ...
                ${kcSanitize(msg("emailSentMessage"))?no_esc}
            </div>
        </div>
    </#if>
