    ...
    <#elseif section = "form">
        ...
        <style>
            ...
            *, *::before, *::after { box-sizing: border-box; }
            ...
            .g-chk  { width:16px;height:16px;border-radius:4px;cursor:pointer;border:1px solid rgba(249,115,22,.3);background:rgba(13,18,37,.8);accent-color:#f97316; }
            .g-reml { font-size:13px;color:#94a3b8;cursor:pointer;user-select:none; }
            .g-forg { font-family:'JetBrains Mono',monospace;font-size:11px;color:#fb923c;text-decoration:none;letter-spacing:.06em;transition:color .2s; }
            ...
            .g-div::before,.g-div::after { content:'';flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(249,115,22,.15),transparent); }
            .g-reg  { text-align:center;font-size:13px;color:#94a3b8;margin-top:14px; }
            .g-reg a { color:#fb923c;text-decoration:none;font-weight:600;transition:color .2s; }
